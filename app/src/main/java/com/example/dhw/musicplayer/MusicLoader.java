...
public class MusicLoader {
	...
	private static final String TAG = "com.example.filedemo.MusicLoader";
...
//	private String sortOrder = Media.DATA;
	...
	/**
	 * 构造函数主要完成以下工作:
	 * 利用contentResolver根据Android原生已经想歪提供的uri查询音乐信息,
	 * 并且封装到MusicList这一个List里面
	 * 
	 */
	private MusicLoader(){		
	...
	/**
	 * 构造函数主要完成以下工作:
	 * 利用contentResolver根据Android原生已经提供的uri查询音乐信息,
	 * 并且封装到MusicList这一个List里面
	 */
